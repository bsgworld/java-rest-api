...
Ѕиблиотека позвол€ет работать с REST сервисом BSG. ѕоддерживаетс€ автоматическа€ сериализаци€/десериализаци€ в Java объекты
...
Ёта библиотека сопровождаетс€ файлом pom.xml, что позвол€ет использовать Maven дл€ его инсталл€ции в локальный репозиторий.

mvn install:install-file -Dfile=RestClient-1.0.jar

“ак же можно установить его, загрузив исходные коды пакета в виде Zip архива или клонировав этот репозиторий. ¬се компоненты этой библиотеки загружают зависимости автоматически.

ƒл€ использовани€ библиотеки необходимо добавить в pom.xml dependencies
...
≈сли у вас возникли сложности или вопросы по использованию пакета, создайте обсуждение в данном репозитории или напишите на электронную почту.

## Documentation	

ƒокументацию API можно получить из исходных кодов пакета
